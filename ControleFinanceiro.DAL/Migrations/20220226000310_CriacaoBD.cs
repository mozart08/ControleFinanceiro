        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CPF = table.Column<int>(maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DespesaId = table.Column<int>(maxLength: 50, nullable: false),
                    CartaoId = table.Column<int>(nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "eb9a0ba2-0992-4add-9fef-7225a9c90fe9", "63b98bc2-6b50-4fd4-9560-ab4bf059b6b7", "Administrador do Sistema", "Administrador", "ADMINISTRADOR" },
                    { "12df5131-0e73-4170-b518-a9b8610e99b9", "b9cace25-9bc3-4b18-9e27-ef5aa76ef034", "Usuario do Sistema", "Usuario", "USUARIO" }
                });
