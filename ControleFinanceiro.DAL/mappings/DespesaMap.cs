...
namespace ControleFinanceiro.DAL.mappings
{
    public class DespesaMap : IEntityTypeConfiguration<Despesa>
    {
        public void Configure(EntityTypeBuilder<Despesa> builder)
        {
            ...
            builder.Property(d => d.DespesaId).IsRequired().HasMaxLength(50);
            ...
            builder.HasOne(d => d.Cartao).WithMany(d => d.Despesaas).HasForeignKey(d=>d.DespesaId).IsRequired();
            builder.HasOne(d => d.Cartao).WithMany(d => d.Despesaas).HasForeignKey(d => d.DespesaId).IsRequired();
            builder.HasOne(m => m.Mes).WithMany(d => d.Despesas).HasForeignKey(d => d.MesId).IsRequired();
